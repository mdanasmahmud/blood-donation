...
const UserContact = (props) => {
    ...
    return (
        <div>
            ...
            <form class=" bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700 p-5 max-w-screen-sm mx-auto">
            <div>
            ...
            <div class="mb-5">
                ...
                <button type="button" class="mt-5 text-white bg-gradient-to-br from-purple-600 to-blue-500 hover:bg-gradient-to-bl focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center me-2 mb-2" onClick={handleChange}>Send Message</button>
            </form>
        </div>
    )
};
