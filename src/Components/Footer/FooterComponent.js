    ...
    return (
        <footer className="w-full bg-white dark:bg-gray-900">
            <div className="max-w-screen-xl mx-auto p-4 md:py-8">
                ...
                <span className="block text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2024 <a href="https://flowbite.com/" className="hover:underline">Anas</a>. All Rights Reserved.</span>
            </div>
        </footer>
    );
}
