...
<div class="py-8 px-4 mx-auto max-w-screen-xl lg:py-16">
    <ol class="relative border-s border-gray-200 dark:border-gray-700">                  
        <li class="mb-10 ms-4">
            ...
            <h3 class="text-lg font-semibold text-gray-900 dark:text-white">Created The Website</h3>
            <p class="mb-4 text-base font-normal text-gray-500 dark:text-gray-400">This Website will act to help people who are in need of blood</p>
